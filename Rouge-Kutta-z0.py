...
def on_calcular_button(widget, expressao_input, y0_input, x0_input, z0_input, h_input, nfinal_input, resultado_label):
    expressao_str = expressao_input.value
    y0 = float(y0_input.value)
    x0 = float(x0_input.value)
    z0 = float(z0_input.value)  # Lê o valor inicial de z
...
def build(app):
    ...
    z0_label = toga.Label("z0:", style=Pack(padding=5))  # Adicione um novo campo para z0
    z0_input = toga.TextInput(style=Pack(padding=5))     # Adicione um novo campo para z0
    ...
    calcular_button = toga.Button("Calcular",
                                  on_press=lambda widget: on_calcular_button(widget, expressao_input, y0_input,
                                                                             x0_input, z0_input, h_input, nfinal_input,
    ...
    box = toga.Box(
        children=[
            ...
            x0_label, x0_input,
            y0_label, y0_input,
            z0_label, z0_input,  # Inclua o campo de entrada para z0
            h_label, h_input,
